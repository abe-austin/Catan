...
public class Player {
	private CatanColor color;
        ...
        /**
         * adds a resource to the player;s resource cards
         * @param resourceCard the card to be given to the player
         */
        public void addResourceCard(ResourceCard resourceCard){
            resourceCards.add(resourceCard);
        }
        /**
         * removes a resource card from the player and gives it to someone else (or bank)
         * @pre   player has at least one card of the specified resource type
         * @post  the player has one less resource card of the specified type
        ...
        /**
         * adds a specified development card to the player's development cards
         * @param devCard the development card to be given to the player
         */
